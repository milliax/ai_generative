...
- **📝 訂單估價**：填結構化規格表單（產品族 / 芯數 / 截面積 / 數量 / 交期，必填欄位填齊才能估價）→ 跑 orchestrator → 顯示估價 / 交期 / 產能 / 風險、**AI 中文估價分析**與參考歷史訂單（可點進詳情）。結果以 newest-first 累積在可捲動區。
- **📋 歷史訂單**：以表格列出全部歷史訂單（重要欄位）＋客戶 / 產品族 / 風險等 filter，點一列看完整詳情
